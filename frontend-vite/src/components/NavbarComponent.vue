    ...
    <div class="miNavBarRow">
      ...
      <div class="nav row align-items-strech justify-content-center">
        ...
        >
          ...
          <span>&nbsp;<v-icon name="fa-regular-dot-circle" class="color-0" /></span>
          <p>&nbsp;{{ $t('comun.proyecto') }}</p>
          &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <nav class="col-md-12 col-lg-auto menu d-flex align-items-stretch flex-wrap flex-sm-nowrap">
          ...
          <a
            target="_blank"
            href="/papeleriaDesktopJWT.exe"
            download
            class="color-1 d-flex align-items-center"
            v-if="authStore.token != null"
          >
            <div class="d-flex flex-column text-center">
              <!--Con Flex-Column hacemos que el  texto este arriba y el icono abajo-->
              <span>{{ $t('comun.desktopApp') }}</span>
              <span><v-icon name="fa-windows" /></span>
            </div>
          </a>
          <RouterLink
            :to="{ name: 'clientes' }"
          ...
          <RouterLink :to="{ name: 'clientes' }" class="color-2 d-flex align-items-center">
            <div class="d-flex flex-column text-center">
              <!--Con Flex-Column hacemos que el  texto este arriba y el icono abajo-->
          ...
          <RouterLink :to="{ name: 'productos' }" class="color-3 d-flex align-items-center">
            <div class="d-flex flex-column text-center">
              <!--Con Flex-Column hacemos que el  texto este arriba y el icono abajo-->
              <span>{{ $t('productos.productos', 2).toUpperCase() }}</span>
              <span><v-icon name="fa-book" />&nbsp;&nbsp;<v-icon name="fa-address-book" /></span>
            </div>
          </RouterLink>
