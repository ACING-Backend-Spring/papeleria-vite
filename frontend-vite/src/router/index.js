...
import ProductosDeClienteView from '@/views/ProductosDeClienteView.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/clientes/:id/productos', //lo dejo para tener ejemplo de parametros en rutas y lo dejo abierto para probarlo...
      name: 'productos-cliente',
      component: ProductosDeClienteView,
      meta: {
        requireAuth: false,
      },
    },
