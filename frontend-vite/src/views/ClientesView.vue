<template>
  ...
  <div class="row justify-content-end">
    ...
    <button
      ...
      data-bs-target="#modal-nuevo-cliente"
    >
  ...
  <div class="row justify-content-end mt-2" v-if="buscar">
    ...
    <label class="mt-2 col-2"
      ><b>{{ $t('clientes.mailEmpresa') }}:</b></label
    >
    <input
      class="col-2"
      type="text"
      name="empresa"
      :placeholder="$t('clientes.empresa')"
      v-model="empresa"
    />&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div class="container">
    <input
      type=" text"
      :placeholder="$t('clientes.filtrar')"
      class="mr-5"
      v-model="search"
  ...
  <div
    ...
    tabindex="-1"
    aria-labelledby="modal-nuevo-cliente-Label"
    aria-hidden="true"
  >
...
const crearCliente = async () => {
  await service.crearCliente(nombreCliente.value, correoCliente.value)
  nombreCliente.value = ''
  correoCliente.value = ''
  await getClientes()
}
