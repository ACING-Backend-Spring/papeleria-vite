      ...
      VitePWA({
        manifest: {
          screenshots: [
            ...
            {
              src: `${normalizedBase}img/screenshot_productosdeclientes.png`,
              sizes: '1500x900',
              type: 'image/png',
            },
            {
              src: `${normalizedBase}img/screenshot_productoscards.png`,
              sizes: '1500x900',
              type: 'image/png',
            },
            {
          ...
          description: 'Aplicación para la gestión de mi papelería',
          theme_color: '#ff0000',
